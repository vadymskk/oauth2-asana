...
```
composer require worksection/oauth2-asana
```

### Usage

Usage is the same as The League's OAuth client, using `\Worksection\OAuth2\Client\Provider\Asana` as the provider.

### Authorization Code Flow

```php
$provider = new Worksection\OAuth2\Client\Provider\Asana([
